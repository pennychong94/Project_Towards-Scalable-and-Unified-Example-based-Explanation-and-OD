...
if __name__=='__main__':
    ...
    ##python gen_synthetic_strokes.py --dataset stanfordcar --thickness 5 --rootPath /path/to/stanford_cars/ --mousePath standardized_balabit_twos/balabit/fused_train_images_1s_1.0_with_time_v2.json
    ...
    if args.dataset=='stanfordcar':
        ...
        new_direc="../../stanfordcar_synthetic/strokes_"+str(args.thickness)
