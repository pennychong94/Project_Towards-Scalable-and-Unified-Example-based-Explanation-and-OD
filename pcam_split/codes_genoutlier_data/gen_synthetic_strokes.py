...
def run(thickness, image_size, textfile_path, prefix_image, new_direc, seq_list):
    ...
    for c in range(num_images):
         ...
         gen_strokes(image_size, thickness, c, new_direc, sub_seq_list,im_np)


def gen_strokes(image_size, thickness, c, new_direc, sub_seq_list, im_np):
...
if __name__=='__main__':
    ...
    #python gen_synthetic_strokes.py --dataset patchcam --thickness 5 --rootPath /rootpath/to/new_allcls_patchcam_split/ --mousePath standardized_balabit_twos/balabit/fused_train_images_1s_1.0_with_time_v2.json


    parser = argparse.ArgumentParser(description='generate synthetic patch cam data')
    ...
    if args.dataset=='patchcam':
        ...
        new_direc="../../patchcam_synthetic/strokes_"+str(args.thickness)
